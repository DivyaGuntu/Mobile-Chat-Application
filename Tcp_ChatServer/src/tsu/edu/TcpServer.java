...
public class TcpServer extends Thread implements UserManager.UserManagerDelegate {
    ...
    private void runServer() {
        ...
        try {
           ...
           // System.out.println("IP of the server is := " + IP.getHostAddress());
            messageListener.messageReceived("You can connect using IP :"+IP.getHostAddress()+" Port : 8000");
            messageListener.messageReceived("Server started : Waiting for clients ...");
    ...
    public void messageReceived(User fromUser, User toUser) {
        ...
        messageListener.messageReceived(fromUser.getUsername() + " says: " + fromUser.getMessage() /*+ " to all clients": " + (toUser == null ? "ALL" : toUser.getUsername())*/);
